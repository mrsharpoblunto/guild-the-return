...
max = 256
Dim Shared dot(max) As dot, f(10) As fadebox
...
Sub fade
    ...
    Do
        a = a - 1
        Line (x - 63 - a, y - 40 - a)-(x + 87 + a, y + 40 + a), a, BF
    Loop Until a = 1
    ...
    For y1 = (14 * 8) To (15 * 8)
        For x1 = (14 * 8) To (25 * 8)
            If Point(x1, y1) = 0 Then Line (x1, y1)-(x1, y1), 17
        Next
    Next
    ...
    For a = 0 To 63
        For b = 1 To 10
            Palette b, (65536 * CInt(a * (Abs(11 - b) / 10)) + 256 * CInt(a * (Abs(11 - b) / 10)) + CInt(a * (Abs(11 - b) / 10)))
        Next
        Palette 17, (65536 * a + 256 * a + a)
    ...
    For b = 1 To 10
        f(b).c = (65536 * CInt(63 * (Abs(11 - b) / 10)) + 256 * CInt(63 * (Abs(11 - b) / 10)) + CInt(63 * (Abs(11 - b) / 10)))
    Next
    ...
    For a = 0 To 63
        ...
        Palette 15, (65536 * a + 256 * a + a)
        Palette 16, (65536 * a + 256 * a + a)
        For b = 1 To 10
            If (65536 * a + 256 * a + a) > f(b).c Then Palette b, (65536 * a + 256 * a + a)
        Next
    ...
    For a = 0 To 63
        ...
        Palette 16, (65536 * Abs(63 - a) + 256 * Abs(63 - a) + Abs(63 - a))
        Palette 15, (65536 * Abs(63 - a) + 256 * Abs(63 - a) + Abs(63 - a))
        Palette 17, (65536 * Abs(63 - a) + 256 * Abs(63 - a) + Abs(63 - a))
        For b = 1 To 10
